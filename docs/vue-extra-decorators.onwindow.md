...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [OnWindow](./vue-extra-decorators.onwindow.md)
...
```typescript
declare function OnWindow(...events: string[]): TypedPropertyDecorator<AnyFunction>;
```

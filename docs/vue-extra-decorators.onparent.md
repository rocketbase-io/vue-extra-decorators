...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [OnParent](./vue-extra-decorators.onparent.md)
...
```typescript
declare function OnParent(...events: string[]): TypedPropertyDecorator<AnyFunction>;
```

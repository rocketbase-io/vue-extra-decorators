...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [DProp](./vue-extra-decorators.dprop.md)
...
```typescript
declare function DProp(opts?: PropOpts<Date>): TypedPropertyDecorator<Date>;
```

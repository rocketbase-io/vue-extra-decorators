...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [On](./vue-extra-decorators.on.md)
...
```typescript
declare function On(...events: string[]): TypedPropertyDecorator<AnyFunction>;
```

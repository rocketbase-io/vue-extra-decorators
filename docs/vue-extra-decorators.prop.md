...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [Prop](./vue-extra-decorators.prop.md)
...
```typescript
declare function Prop<T>(opts?: PropOpts<T>, typeOverride?: Constructor<T>): TypedPropertyDecorator<T>;
```

...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [ClassesKebap](./vue-extra-decorators.classeskebap.md)
...
```typescript
declare function ClassesKebap(prefix?: string, infix?: string): ReturnType<typeof Classes>;
```

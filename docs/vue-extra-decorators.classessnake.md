...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [ClassesSnake](./vue-extra-decorators.classessnake.md)
...
```typescript
declare function ClassesSnake(prefix?: string, infix?: string): ReturnType<typeof Classes>;
```

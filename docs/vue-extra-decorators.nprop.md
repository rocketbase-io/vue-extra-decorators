...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [NProp](./vue-extra-decorators.nprop.md)
...
```typescript
declare function NProp(opts?: PropOpts<number>): TypedPropertyDecorator<number>;
```

...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [BProp](./vue-extra-decorators.bprop.md)
...
```typescript
declare function BProp(opts?: PropOpts<boolean>): TypedPropertyDecorator<boolean>;
```

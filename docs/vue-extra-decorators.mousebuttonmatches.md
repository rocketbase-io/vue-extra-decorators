...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [mouseButtonMatches](./vue-extra-decorators.mousebuttonmatches.md)
...
```typescript
declare function mouseButtonMatches(...buttons: MouseButton[]): (ev: MouseEvent) => boolean;
```

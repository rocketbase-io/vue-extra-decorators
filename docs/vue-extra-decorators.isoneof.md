...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [isOneOf](./vue-extra-decorators.isoneof.md)
...
```typescript
declare function isOneOf(path: string, ...values: any[]): (data: any) => boolean;
```

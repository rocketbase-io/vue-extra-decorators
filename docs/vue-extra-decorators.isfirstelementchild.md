...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [isFirstElementChild](./vue-extra-decorators.isfirstelementchild.md)
...
```typescript
declare function isFirstElementChild(ev: Event): boolean | null;
```

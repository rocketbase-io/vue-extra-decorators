...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [or](./vue-extra-decorators.or.md)
...
```typescript
declare function or(...fns: TFunction<boolean>[]): TFunction<boolean>;
```

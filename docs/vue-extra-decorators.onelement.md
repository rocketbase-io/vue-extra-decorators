...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [OnElement](./vue-extra-decorators.onelement.md)
...
```typescript
declare function OnElement(...events: string[]): TypedPropertyDecorator<AnyFunction>;
```

...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [isLastElementChild](./vue-extra-decorators.islastelementchild.md)
...
```typescript
declare function isLastElementChild(ev: Event): boolean | null;
```

...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [isEqual](./vue-extra-decorators.isequal.md)
...
```typescript
declare function isEqual(path: string, value: any): (data: any) => boolean;
```

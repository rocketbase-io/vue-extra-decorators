...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [SProp](./vue-extra-decorators.sprop.md)
...
```typescript
declare function SProp(opts?: PropOpts<string>): TypedPropertyDecorator<string>;
```

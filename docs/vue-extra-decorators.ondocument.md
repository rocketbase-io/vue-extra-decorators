...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [OnDocument](./vue-extra-decorators.ondocument.md)
...
```typescript
declare function OnDocument(...events: string[]): TypedPropertyDecorator<AnyFunction>;
```

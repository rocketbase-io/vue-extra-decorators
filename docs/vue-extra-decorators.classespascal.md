...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [ClassesPascal](./vue-extra-decorators.classespascal.md)
...
```typescript
declare function ClassesPascal(prefix?: string, infix?: string): ReturnType<typeof Classes>;
```

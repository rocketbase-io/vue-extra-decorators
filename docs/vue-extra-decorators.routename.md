...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [RouteName](./vue-extra-decorators.routename.md)
...
```typescript
declare function RouteName(): TypedPropertyDecorator<string | undefined>;
```
<b>Returns:</b>

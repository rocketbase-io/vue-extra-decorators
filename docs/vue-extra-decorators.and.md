...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [and](./vue-extra-decorators.and.md)
...
```typescript
declare function and(...fns: TFunction<boolean>[]): TFunction<boolean>;
```

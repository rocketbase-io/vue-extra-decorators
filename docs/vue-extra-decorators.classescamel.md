...
[Home](./index.md) &gt; [@rocketbase/vue-extra-decorators](./vue-extra-decorators.md) &gt; [ClassesCamel](./vue-extra-decorators.classescamel.md)
...
```typescript
declare function ClassesCamel(prefix?: string, infix?: string): ReturnType<typeof Classes>;
```
